...
class LTC6811Bus {
 public:
  ...
  static Command buildAddressedCommand(uint8_t addr, LTC6811Command const &cmd);
  static Command buildBroadcastCommand(LTC6811Command const &cmd);

  LTC6811Bus(SPI *spiDriver);
